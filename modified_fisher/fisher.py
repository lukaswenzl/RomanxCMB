...
class Fisher(object):
    ...
    def compute_derivatives(self):
        ...
        data, inv_cov = self.compute_vector(points[0], cov=True, get_data_vector_instead=True)
        ...
        return derivatives, inv_cov, data


    def compute_fisher_matrix(self, return_derivatives_icov_data=False):
        derivatives, inv_cov, data = self.compute_derivatives()
        ...
        if return_derivatives_icov_data:
            return fisher_matrix, derivatives, inv_cov, data
        else:
