...
ax[0,0].set_title("g1g1")
ax[0,0].set_ylabel("$C_l \cdot l(l+1) (2\pi)^{-1}$")
ax[0,0].set_xlabel("l")

ax[0,1].set_title("g5g5")
ax[0,2].set_title("g10g10")
...
for mu0 in [ 0.,-0.2, 0.2]:
    ...
    cl11  = data['galaxy_cl', 'bin_1_1'] * ell * (ell+1) / 2. /np.pi
    cl55  = data['galaxy_cl', 'bin_5_5'] * ell * (ell+1) / 2. /np.pi
    cl1010  = data['galaxy_cl', 'bin_10_10'] * ell * (ell+1) / 2. /np.pi
...
# Save our plot.
ax[0,0].legend()
plt.savefig(output_folder+"Clgg_modgrav_dependenceRAW.pdf")
