...
!
  ...
  !*** Start of declarations inserted by SPAG
        REAL*8 age , ALPha_nu , anorm , arg , BETa_c , dd0 , dd_cb ,      &
             & dd_cbnu , deltac , dum1 , dum2 , dum3 , ERFCC , F_Baryon , &
             & F_Nu , g , h , k , kmax , kmin
        INTEGER numk
        INTEGER i , IPOwer , iz
        REAL*8 OMEga , omegab , omegae , omegagas , OMEgal , omeganu ,    &
             & omegaz , OMHh , ROMBINT , SCAle , sigmadla , SIGMAGAUS ,   &
             & SIGMATOP , SIGMAVTOP , sigmav_40 , sigma_50 , sigma_8 ,    &
             & sigma_lya , SOUnd_horizon , tau
        REAL*8 TF_MASTER , THEta_cmb , TILt , tol , t_cmb , t_master ,    &
  ...
  !*--SIGMATOP701
  !*** Start of declarations inserted by SPAG
        REAL*8 dd0 , dd_cb , dd_cbnu , k , Kl , SCAle , TF_MASTER , TILt ,&
             & x , Z
        INTEGER IPOwer
  !*** End of declarations inserted by SPAG
        COMMON /PASSSIGMA/ SCAle , TILt , Z , IPOwer
  ...
  !*** Start of declarations inserted by SPAG
        ...
        REAL*8 SCAle , SOUnd_horizon , TF_MASTER , THEta_cmb , TILt , x , &
