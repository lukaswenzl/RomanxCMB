...
g_cosmolike = load_cov("../6x2pt_Roman_SO_cosmolike_v0_9_f4e0f91.fits", "cosmolike")
g1 = load_cov("../6x2pt_Roman_SO_v0_9_f4e0f91.fits", "cosmosis EH99 type1 (sum l bins)")
g2 = load_cov("../6x2pt_Roman_SO_type2_v0_9_f4e0f91.fits", "cosmosis EH99 type2 (multiply delta l)")
...
plt.savefig("v0_9_compare_diag_ratioRAW.pdf")