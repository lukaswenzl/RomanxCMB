...
g_cosmolike = load_cov("../6x2pt_Roman_SO_cosmolike_v1_0_4ff7963.fits", "cosmolike")
g1 = load_cov("../6x2pt_Roman_SO_v1_0_4ff7963.fits", "cosmosis EH99 type1 (sum l bins)")
g2 = load_cov("../6x2pt_Roman_SO_type2_v1_0_4ff7963.fits", "cosmosis EH99 type2 (multiply delta l)")
...
fig.suptitle("Diag of Covariance, g(label)+ng(cosmolike), baryonic feedback on")
...
plt.savefig("v1_0_compare_diag_ratioRAW.pdf")